...
export function HeadImage(){
 return(
  <div className="pr-8 pl-8">
    <Image className="rounded-2xl md:w-[40rem] lg:w-[60rem]" src={mockupImage} width={400} height={350} alt="mockup image"/>
  </div>
 )
}
...
export function ThumbnailBg({imageUrl}: ThumbnailBgProps){
  return(
    <div className="p-4 rounded-2xl bg-gray-600 md:w-[40rem] lg:ml-[8rem] lg:mr-[8rem] lg:p-[2.5rem] lg:w-[60rem]">
...
export function ThumbnailBg2({imageUrl}: ThumbnailBgProps){
  return(
    <div className="p-4 rounded-2xl bg-gray-600 flex flex-col gap-8 md:w-[40rem]lg:w-[30rem] ">
...
export function ThumbnailBg3({imageUrl, logoUrl}: ThumbnailBg3Props){
  return(
    <div className="p-4 rounded-2xl bg-gray-600 flex flex-col gap-8 md:w-[40rem">
...
export function Tantalizer(){
  return(
   <div className="bg-black pb-8 pt-12 text-white text-[20px] overflow-hidden">
      ...
      <section className="md:flex md:gap-10 md:text-[15px] md:mt-8 md:pl-[3rem] md:pr-[3rem] lg:pl-[10rem] lg:pr-[10rem]">
        <section className="text-white mt-4 gap-0 flex pl-6 md:flex md:flex-col">
          ...
          <div className="flex flex-col gap-4 list-none mb-2 w-[12rem]">
             <div className="flex flex-col w-80 text-[17px] lg:text-[14px]">
                <li className="font-bold text-[20px] lg:text-[14px]">Responsibilities:</li>
                <li>User Research</li>
       ...
       <section className="mt-8 bg-amber-900 pl-10 pt-8 pr-10 pb-10 lg:pl-[8rem] lg:pr-[10rem]">
         <div>
           <h2 className="text-4xl pb-6 font-bold">THE PROBLEM</h2>
         ...
         <div className="mt-14">
           <h2 className="text-4xl pb-6 font-bold">THE SOLUTION</h2>
      ...
      <section className="bg-amber-800 mt-8 pt-6 pl-6 pr-6 pb-8 md:pt-10 lg:pl-[3rem] lg:pr-[2rem] lg:flex lg:gap-[2.5rem]">
          <div className="flex flex-col gap-4 lg:flex">
            <h2 className="text-[27px] md:text-4xl lg:text-2xl">Website Visitor&#39;s Painpoint</h2>
      ...
      <section className="mt-12 pl-8 pr-8 lg:pl-[8rem]">
      ...
      <section className="mt-12 pl-8 pr-8 md:mt-10 lg:pl-[8rem] lg:pr-[8rem] lg:mt-[5rem]">
      ...
      <section className="mt-16 mb-20 pl-8 pr-8 text-[15px] md:pl-[4rem] lg:pl-[8rem] lg:pr-[8rem]">
      ...
      <section className="p-5 bg-amber-900 mb-20 md:pl-[2.5rem] lg:p-[2rem] lg:pl-[5rem] lg:pr-[5rem]">
          <h3 className="lg:text-4xl">TIME TO RETROSPECT!</h3>
      ...
      <section className="text-center flex flex-col items-center justify-center md:text-4xl lg:flex lg:flex-row lg:ml-[5rem] lg:mr-[5rem] lg:gap-[2rem]">
          ...
          <div className="p-8">
            <Image src={footerImage} className="lg:w-[35rem]" alt="footerImage" />
          </div>
      </section>
